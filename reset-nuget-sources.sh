...
dotnet nuget add source https://nexus.viavarejo.com.br/repository/nuget-online/ --name Core --username 4960017680 --password $password --store-password-in-clear-text
dotnet nuget add source https://nexus.viavarejo.com.br/repository/viaunica-core/ --name Via --username 4960017680 --password $password --store-password-in-clear-text
